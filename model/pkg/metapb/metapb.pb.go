...
type ReadFromNode int32

const (
	// 仅 master 读
	ReadFromNode_ReadFromLeader ReadFromNode = 0
	// 读写分离(leader写，follower读)
	ReadFromNode_ReadFromFollower ReadFromNode = 1
	// 混合读(leader\follower都可读)
	ReadFromNode_ReadFromAnyNode ReadFromNode = 2
)

var ReadFromNode_name = map[int32]string{
	0: "ReadFromLeader",
	1: "ReadFromFollower",
	2: "ReadFromAnyNode",
}
var ReadFromNode_value = map[string]int32{
	"ReadFromLeader":   0,
	"ReadFromFollower": 1,
	"ReadFromAnyNode":  2,
}

func (x ReadFromNode) String() string {
	return proto.EnumName(ReadFromNode_name, int32(x))
}
func (ReadFromNode) EnumDescriptor() ([]byte, []int) { return fileDescriptorMetapb, []int{5} }
...
type Route struct {
	...
	PeerStatus []*PeerStatus `protobuf:"bytes,3,rep,name=peer_status,json=peerStatus" json:"peer_status,omitempty"`
}
...
func (m *Route) GetPeerStatus() []*PeerStatus {
	if m != nil {
		return m.PeerStatus
	}
	return nil
...
type Table struct {
	...
	ReadFromNode   ReadFromNode `protobuf:"varint,14,opt,name=read_from_node,json=readFromNode,proto3,enum=metapb.ReadFromNode" json:"read_from_node,omitempty"`
}
...
func (m *Table) GetReadFromNode() ReadFromNode {
	if m != nil {
		return m.ReadFromNode
	}
	return ReadFromNode_ReadFromLeader
}
...
func init() {
	...
	proto.RegisterEnum("metapb.ReadFromNode", ReadFromNode_name, ReadFromNode_value)
}
...
func (m *Route) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.PeerStatus) > 0 {
		for _, msg := range m.PeerStatus {
			dAtA[i] = 0x1a
			i++
			i = encodeVarintMetapb(dAtA, i, uint64(msg.Size()))
			n, err := msg.MarshalTo(dAtA[i:])
...
func (m *Table) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.ReadFromNode != 0 {
		dAtA[i] = 0x70
		i++
		i = encodeVarintMetapb(dAtA, i, uint64(m.ReadFromNode))
	}
	return i, nil
}
...
func (m *Table) Size() (n int) {
	...
	if m.ReadFromNode != 0 {
		n += 1 + sovMetapb(uint64(m.ReadFromNode))
	}
	return n
}
...
func (m *Route) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			...
			m.PeerStatus = append(m.PeerStatus, &PeerStatus{})
			if err := m.PeerStatus[len(m.PeerStatus)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *Table) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 14:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field ReadFromNode", wireType)
			}
			m.ReadFromNode = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.ReadFromNode |= (ReadFromNode(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
var fileDescriptorMetapb = []byte{
	...
	,
}
